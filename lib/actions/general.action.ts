...
export async function getInterviewById(id: string): Promise<Interview | null> {
    const interview = await adminDB.collection('interviews')
        .doc(id).get();
    ...
    try {
      ...
      const { object } = await generateObject({
        ...
        prompt: `
          ...
          Please score the candidate from 0 to 100 in exactly these 5 categories. Return exactly 5 category scores:
